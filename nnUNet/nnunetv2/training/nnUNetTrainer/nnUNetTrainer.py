...
from nnunetv2.training.lr_scheduler.polylr import PolyLRScheduler, PolyLRScheduler_Custom
...
class nnUNetTrainer(object):
    ...
    def configure_optimizers(self):
        ...
        if hasattr(self, 'total_rounds') and hasattr(self, 'current_round'): # me add
            lr_scheduler = PolyLRScheduler_Custom(optimizer, self.initial_lr, self.num_epochs, self.current_round, self.total_rounds)
    ...
    def run_training(self):
        self.print_to_log_file(f'The experiment is set with {self.num_epochs} number of local epochs. \n') # me add
