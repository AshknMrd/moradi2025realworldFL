...
class ExperimentPlanner(object):
    def __init__(self, dataset_name_or_id: Union[str, int],
        ...
        self.dataset_json_dir = dataset_json_dir #ADDED
        if dataset_json_dir is not None: #ADDED
            self.dataset_json = load_json(dataset_json_dir) #ADDED
        else:
            self.dataset_json = load_json(join(self.raw_dataset_folder, 'dataset.json')) #ADDED
    ...
    def plan_experiment(self):
        ...
        # per file.
        if self.dataset_json_dir is not None: # ADDED
            shutil.copy(self.dataset_json_dir, # ADDED
                        join(nnUNet_preprocessed, self.dataset_name, 'dataset.json')) # ADDED
        else:
            shutil.copy(join(self.raw_dataset_folder, 'dataset.json'), # ADDED
                        join(nnUNet_preprocessed, self.dataset_name, 'dataset.json')) # ADDED
