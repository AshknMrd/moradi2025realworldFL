...
class DatasetFingerprintExtractor(object):
    def __init__(self, dataset_name_or_id: Union[str, int], num_processes: int = 8, dataset_json_dir: str = None, verbose: bool = False): #ADDED
        """
        ...
        if dataset_json_dir is not None: #ADDED
            ...
            self.dataset_json = load_json(join(self.input_folder, 'dataset.json')) #ADDED
