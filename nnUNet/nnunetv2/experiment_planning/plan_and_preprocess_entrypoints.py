...
def extract_fingerprint_entry():
    ...
    parser.add_argument("--dataset_json", required=False, default=None, type=str, help="enforce the dataset.json") # ADDED
    ...
    extract_fingerprints(args.d, args.fpe, args.np, args.dataset_json, args.verify_dataset_integrity, args.clean, args.verbose) # ADDED
...
def plan_experiment_entry():
    ...
    args, unrecognized_args = parser.parse_known_args()
    plan_experiments(args.d, args.dataset_json, args.pl, args.gpu_memory_target, args.preprocessor_name, args.overwrite_target_spacing,
                     args.overwrite_plans_name) # ADDED
...
def preprocess_entry():
    ...
    parser.add_argument('-d', nargs='+', type=int,
                        help="[REQUIRED] List of dataset IDs. Example: 2 4 5. This will run fingerprint extraction, experiment "
                             "planning and preprocessing for these datasets. Can of course also be just one dataset")
    parser.add_argument("--dataset_json", type=str, required=False, default=None, help="enforce the dataset.json") # ADDED
    ...
    if args.np is None:
        ...
        np = args.np
    preprocess(args.d, args.dataset_json, args.plans_name, configurations=args.c, num_processes=np, verbose=args.verbose) #ADDED
...
def plan_and_preprocess_entry():
    ...
    extract_fingerprints(args.d, args.fpe, args.npfp, args.dataset_json, args.verify_dataset_integrity, args.clean, args.verbose) # ADDED

    # experiment planning
    print('Experiment planning...')
    plans_identifier = plan_experiments(args.d, args.dataset_json, args.pl, args.gpu_memory_target, args.preprocessor_name,
                                        args.overwrite_target_spacing, args.overwrite_plans_name) # ADDED
    ...
    if not args.no_pp:
        print('Preprocessing...')
        preprocess(args.d, args.dataset_json, plans_identifier, args.c, np, args.verbose)
